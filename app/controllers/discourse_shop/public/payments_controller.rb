...
class DiscourseShop::Public::PaymentsController < DiscourseShop::Public::BaseController
  ...
  def create
    ...
    DiscourseShop::Log.log!("[shop] start pay order ##{order.id} provider=#{provider}")
